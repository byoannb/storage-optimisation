...
* Dans un premier temps, le tri des jeux, avec `sort()`, a une complexité temporelle de $\text{O}(n\log(n))$ dans le pire des cas, car c'est la complexité du tri en général.
